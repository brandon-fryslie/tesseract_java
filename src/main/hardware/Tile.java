...
//    public PixelNode[][] tileNodeArray = new PixelNode[12][12];
//
//
...
//    public PixelNode[] getNodeLayout(int xOffset, int yOffset, int globalIndex){
//        //TODO this could be redone to use the rotation matrix
//
//        PixelNode[] nodeArray = new PixelNode[144];
//        int index = 0;
//
...
//                PixelNode node = new PixelNode(xPos+xOffset-3, yPos+yOffset+3, 0, globalIndex,this);
//                globalIndex++;
//
