...
public class Scene {
  ...
  public Scene(String displayName, TesseractMain.CLIPTYPES clipClass) {
  ...
  public Scene(String displayName, TesseractMain.CLIPTYPES clipClass, float[] clipValues, String filename) {
    this(SceneStore.get().getNextId(), displayName, clipClass, clipValues, filename);
  }

  // Use this constructor when rehydrating from json
  public Scene(int id, String displayName, TesseractMain.CLIPTYPES clipClass, float[] clipValues) {
    this(id, displayName, clipClass, clipValues, null);
  }

  //other constructors all lead here
  public Scene(int id, String displayName, TesseractMain.CLIPTYPES clipClass, float[] clipValues, String filename) {
    this.id = id;
  ...
  public void setClipByClipId(String clipId) {
    ...
    TesseractMain.CLIPTYPES clipClass = Util.getClipEnumValue(clipId);
    this.constructNewClip(clipClass);
  }
  ...
  public void constructNewClip(TesseractMain.CLIPTYPES clipClass) {
